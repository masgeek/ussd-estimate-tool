 ...
 * Generated for Laravel 5.5.13 on 2017-12-09.
 *
...
namespace Jleon\LaravelPnotify { 
    ...
    class Notify {
         ...
         * @static 
         */ 
        public static function message($text, $title = false, $type = 'info')
        {
            return \Jleon\LaravelPnotify\Notifier::message($text, $title, $type);
        }
         ...
         * @static 
         */ 
        public static function success($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::success($text, $title);
        }
         ...
         * @static 
         */ 
        public static function info($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::info($text, $title);
        }
         ...
         * @static 
         */ 
        public static function warning($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::warning($text, $title);
        }
         ...
         * @static 
         */ 
        public static function danger($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::danger($text, $title);
        }
         ...
         * @static 
         */ 
        public static function error($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::error($text, $title);
        }
         ...
         * @static 
         */ 
        public static function dark($text, $title = false)
        {
            return \Jleon\LaravelPnotify\Notifier::dark($text, $title);
        }
        ...
        {
            return \Jleon\LaravelPnotify\Notifier::sticky();
        }
         ...
         * @static 
         */ 
        public static function styling($style = 'bootstrap3')
        {
            return \Jleon\LaravelPnotify\Notifier::styling($style);
        }
         ...
         * @static 
         */ 
        public static function override($configs)
        {
            return \Jleon\LaravelPnotify\Notifier::override($configs);
        }
...
namespace Seguce92\Alerts\Facades { 
    ...
    class Alert {
        ...
        public static function all()
        {
            return \Seguce92\Alerts\AlertsMessage::all();
        }
...
namespace  { 
    ...
    class helpers.php extends \Jleon\LaravelPnotify\Notify {}

    class Alerts extends \Seguce92\Alerts\Facades\Alert {}

    class Uuid extends \Webpatser\Uuid\Uuid {}

    class 0 extends \Seguce92\Alerts\Facades\Alert {}
